...
let score = {
  ...
  crewImg: function() {
    ...
    const crew = [
      {
        scoreValue: 0,
        rankImg: "UFP_logo.svg",
        altText: "Logo for the United Federation of Planets."
      },
      {
        scoreValue: 1,
        rankImg: "UFP_logo.svg",
      ...
      {
        scoreValue: 3,
        rankImg: "obrien-chiefp.jpg",
        altText: "Chief Petty Officer Miles O'Brien"
      },
      {
        scoreValue: 4,
        rankImg: "ensign.jpg",
        altText: "A female Starfleet Ensign."
      },
      {
        scoreValue: 5,
        rankImg: "geordi-ltjunior.jpg",
        altText: "Geordi LaForge, Lt. Junior Grade."
      },
      {
        scoreValue: 6,
        rankImg: "yar-lieutenant.jpg",
        altText:
          "Lieutenant Natasha Yar, Chief of Security aboard the Enterprise."
      },
      {
        scoreValue: 7,
        rankImg: "data-ltcommander.jpg",
        altText: "Lieutenant Commander Data."
      },
      {
        scoreValue: 8,
        rankImg: "beverly-commander.jpg",
        altText: "Commander Beverly C. Crusher, MD."
      },
      {
        scoreValue: 9,
        rankImg: "picard-captain.jpg",
        altText: "Captain Jean-Luc Picard."
      },
      {
        scoreValue: 10,
        rankImg: "nakamura-admiral.jpg",
        altText: "Admiral Tujiro Nakamura."
      }
    ];
...
function renderAnswer(answer) {
  ...
  if (answer === "correct") {
    $(".answer-type").html(
      '<h2 class="correct fade_in" style="display:none">CORRECT</h2>'
    );
    fadeIn();
  } else {
    $(".answer-type").html(
      '<h2 class="incorrect blink_me" style="display:none">INCORRECT</h2>'
    );
    blink();
  }
  ...
  if (questionNum < 9) {
    $(".question-box").html(
      '<button type="button" class="button-next lcars-element button rounded">NEXT</button>'
    );
  } else {
    $(".question-box").html(
      '<button type="button" class="button-results lcars-element button rounded">RESULTS</button>'
    );
  }
}
